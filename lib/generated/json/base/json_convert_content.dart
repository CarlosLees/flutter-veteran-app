...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    ...
    if (<CarRecordListEntity>[] is M) {
      return data.map<CarRecordListEntity>((Map<String, dynamic> e) => CarRecordListEntity.fromJson(e)).toList() as M;
    }
    if (<CarRecordListList>[] is M) {
      return data.map<CarRecordListList>((Map<String, dynamic> e) => CarRecordListList.fromJson(e)).toList() as M;
    }
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    ...
    (CarRecordListEntity).toString(): CarRecordListEntity.fromJson,
    (CarRecordListList).toString(): CarRecordListList.fromJson,
  };
